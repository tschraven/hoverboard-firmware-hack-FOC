...
#define ELECTRIC_BRAKE_ENABLE           // [-] Flag to enable electric brake and replace the motor "freewheel" with a constant braking when the input torque request is 0. Only available and makes sense for TORQUE mode.
 ...
 #define ELECTRIC_BRAKE_SPEED_NEUTRAL  40   // speed “neutral” window (command units)
...
*/
  ...
  #define PRI_INPUT1            2,  200, 2048, 3895, 80      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            2,  200, 2048, 3895, 80      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
