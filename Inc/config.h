...
*/
  ...
  #define PRI_INPUT1            2,  200, 2048, 3895, 300      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            2,  200, 2048, 3895, 300      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
