...
*/
  ...
  #define PRI_INPUT1            2,  1650, 2000, 2480, 80      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #define PRI_INPUT2            2,  1650, 2000, 2480, 80      // TYPE, MIN, MID, MAX, DEADBAND. See INPUT FORMAT section
  #ifdef DUAL_INPUTS
